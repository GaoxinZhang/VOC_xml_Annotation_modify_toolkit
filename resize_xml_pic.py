# %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
# % resize_xml_pic.py
# % To resize xml and corresponding pic.
# % 4-7-2018 Created
# % Author:Zhang
# %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
load_xml_path = os.path.join(root_path, 'Annotations_reannotated_perforation_selected')
# load_img_path = os.path.join(root_path, 'JPEGImages')

save_xml_path = os.path.join(result_path, 'Annotations_reannotated_perforation_selected_resized')

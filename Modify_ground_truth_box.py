...
modified_Classes = ["Crack", "Scratch"]  #List the classes you want to modify
overlap_threshold = 0.08  # gt_box/img_area

root_path = "C:\Users\Hancy\Desktop\Dataset_AIRPLANE5"  #Where to Load
result_path = "C:\Users\Hancy\Desktop\plot_AIRPLANE5"  #Where to generate
...
def modify_xml(xml_name):
    ...
    for obj in objects:
        ...
        if label_name in modified_Classes:
